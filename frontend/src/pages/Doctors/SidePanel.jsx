  ...
  return (
    <div className='shadow-panelShadow p-3 lg:p-5 rounded-md'>
      ...
      <div className="mt-[30px]">
        <p className='text__para mt-0 text-headingColor font-semibold'>Available Time Slots :</p>
        ...
        <ul className="mt-3">
          ...
          <li className="flex items-center justify-between mb-2">
            ...
            <p className='text-[15px] leading-6 text-textColor font-semibold'> 1:00 PM - 6:00 PM </p>
          </li>

          <li className="flex items-center justify-between mb-2">
            <p className='text-[15px] leading-6 text-textColor font-semibold'>Thursday</p>
            <p className='text-[15px] leading-6 text-textColor font-semibold'> 2:00 PM - 8:00 PM </p>
          </li>
